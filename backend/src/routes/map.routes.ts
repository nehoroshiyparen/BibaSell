...
export class MapRouter {
  ...
  setup() {
    ...
    this.router.get(
      "/slug/:slug",
      this.mapController.getMapBySlug.bind(this.mapController),
    );
    this.router.get(
      "/:id",
      this.mapController.getMapById.bind(this.mapController),
    );
    this.router.post(
      "/:id",
      prepareTempDir,
      upload.fields([{ name: "map", maxCount: 1 }]),
    ...
    this.router.delete(
      "/bulk",
      this.mapController.bulkDeleteMaps.bind(this.mapController),
    );
    this.router.delete(
      "/:id",
      this.mapController.deleteMap.bind(this.mapController),
    );
  }
