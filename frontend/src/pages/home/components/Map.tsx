        ...
        <div className="flex flex-col gap-10 h-full justify-end box-border relative bottom-20">
            <div className="h-[65%] w-full flex gap-4">
                <div className="w-[65%] relative">
                    <SvgMap width="100%" height="100%" className="text-at"/>
                ...
                <div className="flex-1 h-full relative">
                    <div className="relative top-80 _casual-span">
                        <span>
                            ...
                            почту <span className="text-as">аааа@mail.ru</span>
                        </span>
                    </div>
                </div>
            </div>
            <div className="flex justify-center">
                <Link to={`/`} className="w-190 border-b-[3px] border-solid border-as text-center box-border pb-4">
                    <div className="font-bold text-as _casual-span">
                        Посмотреть карты
                    </div>
                </Link>
            </div>
